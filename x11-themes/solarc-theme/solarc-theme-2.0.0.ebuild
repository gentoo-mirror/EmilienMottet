...
DESCRIPTION="A flat theme with transparent elements for GTK+3, GTK+2 and GNOME Shell. Based on the Arc theme with Solarized colours."
HOMEPAGE="https://github.com/apheleia/solarc-theme"
SRC_URI="https://github.com/apheleia/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz"
LICENSE="GPL-3"
SLOT="0"
KEYWORDS="~amd64 ~x86"
